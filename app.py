...
def predict():
    if request.method == 'POST':
        ...
        credit = float(request.form['CreditHistory'])
        area = request.form['PropertyArea']
        ...
        return render_template("predictloan.html", prediction_text="loan status =>  {}".format(prediction))
